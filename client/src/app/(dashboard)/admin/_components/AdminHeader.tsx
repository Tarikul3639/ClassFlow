...
export const AdminHeader = ({ count }: { count: number }) => (
  <header className="flex flex-row items-center justify-between gap-4">
    ...
    <Link href="/admin/new" className="flex h-11 w-11 sm:h-12 sm:w-auto sm:px-5 items-center justify-center gap-2 rounded-2xl bg-[#399aef] text-white hover:bg-[#2d84d1] transition-all shadow-lg shadow-blue-100 active:scale-95 shrink-0">
