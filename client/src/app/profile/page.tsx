      ...
      <main className="flex-1 w-full max-w-3xl mx-auto px-6 py-10 flex flex-col gap-6">
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-[#dbe1e6] overflow-hidden">
          <div className="p-4 px-6 border-b border-[#dbe1e6] bg-gray-50/20 flex items-center justify-between">
            <h2 className="text-[13px] font-black text-[#111518] flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-md bg-[#399aef] flex items-center justify-center text-white">
                <User size={14} />
              </div>
              Account Information
            </h2>
