...
const MemberActionMenu: React.FC<MemberActionMenuProps> = ({
  ...
  const itemStyle =
    "flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-600 cursor-pointer transition-all duration-200 focus:bg-[#399aef]/10 focus:text-[#399aef] group outline-none";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={8}
        className="w-48 p-1.5 bg-gray-50 border-slate-200 rounded-2xl shadow-sm animate-in fade-in zoom-in-95 duration-200"
      >
        {/* Header Section */}
