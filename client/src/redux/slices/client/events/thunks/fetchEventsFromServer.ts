...
import { events as CLIENT_EVENT_CREATED } from "@/data/events";
...
const fakeFetchAPI = (): Promise<IEvent[]> =>
  new Promise((resolve) => {
    setTimeout(() => resolve(CLIENT_EVENT_CREATED), 5000); // return initial dummy events
  });

export const fetchEventsFromServer = createAsyncThunk<IEvent[]>(
  "clientEvents/fetchEventsFromServer",
